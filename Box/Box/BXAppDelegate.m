...
- (void)applicationWillResignActive:(UIApplication *)application {
	...
	// certain types of temporary interruptions (such as an incoming phone call or SMS message)
...
- (void)applicationDidEnterBackground:(UIApplication *)application {
	...
	// case it is terminated later. If your application supports background execution, this method
